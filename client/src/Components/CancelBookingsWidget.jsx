...
const CancelBookingsWidget = ({placeId,bookingDetails,setBookingDetails}) => {
  ...
  const cancelBooking = async () => {
    try{
      await axios.delete(`http://localhost:4000/place/${placeId}`,{data : {checkIn,checkOut}});
      await axios.delete('http://localhost:4000/user/bookings',{data : {placeId,bookingId}});
      await axios.delete('http://localhost:4000/booking',{data : {bookingId}});
